    ...
    return (
        ...
        <div className="about-me__info-container">
            <div className="about-me__info">
                ...
                <p className="about-me__text">Я живу в Польше, в Варшаве. Закончила факультет международных отношений СПбГУ. Несколько лет работала копирайтером и SMM специалистом. Недавно начала кодить. Прошла курс веб-разработчика от Яндекс.Практикум и сейчас ищу работу на позицию junior web-developer. Увлекаюсь фотографией и танцами.</p>
